...
class WalkingSpeedChartDataTableViewController: WalkingSpeedDataViewController {
    ...
    lazy var dailyWalkingSpeedChartView: OCKCartesianChartView = {
    ...
    private func setUpHeaderView() {
        headerView.addSubview(dailyWalkingSpeedChartView)
    ...
    private func createChartViewConstraints() -> [NSLayoutConstraint] {
        let leading = dailyWalkingSpeedChartView.leadingAnchor.constraint(equalTo: headerView.leadingAnchor)
        let top = dailyWalkingSpeedChartView.topAnchor.constraint(equalTo: headerView.topAnchor)
        let trailing = dailyWalkingSpeedChartView.trailingAnchor.constraint(equalTo: headerView.trailingAnchor)
        let bottomConstant: CGFloat = showGroupedTableViewTitle ? .itemSpacingWithTitle : .itemSpacing
        let bottom = dailyWalkingSpeedChartView.bottomAnchor.constraint(equalTo: headerView.bottomAnchor, constant: -bottomConstant)
